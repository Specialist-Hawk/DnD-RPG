...
void classWindow() {
	...
	weaponMenu = false;
	combatMenu = false;
	string classOptions[] = { "Knight", "Pyromancer", "Back"};
...
void monsterDetermine() {
	...
	switch(monsterNumber) {
		...
		case 7:
			...
			cout<<"\nAfter battling through the treacherous halls of the dungeon, you finally find yourself standing before the chamber’s entrance. The air grows cold, and an unsettling silence fills the room."<<endl;
